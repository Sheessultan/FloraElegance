-- =============================================================================
-- FloraElegance Plant E-Commerce — Complete Database Schema (Final)
-- Import this file once in phpMyAdmin / MySQL (local or Hostinger).
-- Database name: plant_db (change in backend/.env if different)
-- =============================================================================
